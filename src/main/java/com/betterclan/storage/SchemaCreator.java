...
final class SchemaCreator {
    ...
    static void createTables(DatabaseManager db, Logger log) {
        SqlDialect d = db.getDialect();
        ...
        String[] ddl = {
            ...
            "CREATE TABLE IF NOT EXISTS gc_clans ("
                ...
                + "friendly_fire " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "FALSE" : "0") + ", "
            ...
            "CREATE TABLE IF NOT EXISTS gc_ranks ("
                ...
                + "deletable " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "TRUE" : "1") + ", "
            ...
            "CREATE TABLE IF NOT EXISTS gc_wars ("
                ...
                + "active " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "TRUE" : "1")
                + ")",
            ...
            "CREATE TABLE IF NOT EXISTS gc_player_settings ("
                ...
                + "invite_blocked " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "FALSE" : "0") + ", "
                + "glow_disabled " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "FALSE" : "0") + ", "
        ...
        try (Connection conn = db.getConnection()) {
            ...
            runSafe(stmt, "ALTER TABLE gc_player_settings ADD COLUMN glow_disabled " + bo + " DEFAULT " + (d == SqlDialect.POSTGRES ? "FALSE" : "0"));
