...
public final class RankActions {

    private RankActions() {}

    public static void open(Manager manager, Player player, String rankId) {
        ...
        inv.setItem(4, new ItemBuilder(Management.rankMaterial(rank))
        ...
        if (!Rank.OWNER_ID.equals(rank.getId())) {
