...
public final class BannerPattern {
    ...
    public static void openPatternList(Manager manager, Player player) {
        openPatternList(manager, player, null);
    }

    public static void openPatternList(Manager manager, Player player, String adminClanName) {
    ...
    @SuppressWarnings("unused")
    public static void openPatternTypePicker(Manager manager, Player player, int page) {
    ...
    public static void openPatternTypePicker(Manager manager, Player player, int page, String adminClanName) {
        Clan clan = adminClanName != null ? manager.getClanByName(adminClanName) : manager.getClan(player.getUniqueId());
        if (clan == null) return;
    ...
    @SuppressWarnings("unused")
    public static void openPatternColorPicker(Manager manager, Player player, String patternKey) {
        openPatternColorPicker(manager, player, patternKey, null);
    }

    public static void openPatternColorPicker(Manager manager, Player player, String patternKey, String adminClanName) {
        Clan clan = adminClanName != null ? manager.getClanByName(adminClanName) : manager.getClan(player.getUniqueId());
        if (clan == null) return;
