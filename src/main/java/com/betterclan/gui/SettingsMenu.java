...
public final class SettingsMenu {
    ...
    public static void open(ClanManager manager, ChatInputListener chatInput, Player player) {
        ...
        boolean hasRename    = manager.hasPermission(clan, player.getUniqueId(), ClanPermission.RENAME);
        boolean hasManageRanks = manager.hasPermission(clan, player.getUniqueId(), ClanPermission.MANAGE_RANKS);
        boolean hasFF        = manager.hasPermission(clan, player.getUniqueId(), ClanPermission.FRIENDLY_FIRE);
        boolean hasSetTag    = manager.hasPermission(clan, player.getUniqueId(), ClanPermission.SET_TAG);
        boolean hasLog       = manager.hasPermission(clan, player.getUniqueId(), ClanPermission.VIEW_LOG);
