...
public final class DynamicTagColorMenu {

    private DynamicTagColorMenu() {}
    ...
    public static void open(ClanManager manager, Player player, String adminClanName, int page) {
            ...
            if (locked) {
                ...
                ib = new ItemBuilder(mat)
                        ...
                        .lore("",
                                ...
                                "")
                        .persistData(TagColorMenu.TAG_FORMAT_KEY, format);
                if (selected) ib.glow();
            }
