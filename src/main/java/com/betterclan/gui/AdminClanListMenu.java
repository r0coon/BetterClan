...
public final class AdminClanListMenu {

    public static final int ITEMS_PER_PAGE = 28;

    private AdminClanListMenu() {}
    ...
    private static void build(ClanManager manager, Player player, List<Clan> clans, int page, String query) {
