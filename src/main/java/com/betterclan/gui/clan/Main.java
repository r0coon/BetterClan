...
public final class Main {
    ...
    private static void openNoClan(Manager manager, Player player) {
    ...
    private static void openInClan(Manager manager, Player player, Clan clan) {
        ...
        boolean hasAlly = manager.hasPermission(clan, player.getUniqueId(), Permission.ALLY);
        boolean hasWar = manager.hasPermission(clan, player.getUniqueId(), Permission.WAR);
        boolean hasVault = manager.hasPermission(clan, player.getUniqueId(), Permission.VAULT);
        ...
        War activeWar = manager.getActiveWar(clan.getName());
