...
public final class Log {
    ...
    public static void openForAdmin(Manager manager, Player player, String clanName) {
        openForAdmin(manager, player, clanName, 1);
    }

    public static void openForAdmin(Manager manager, Player player, String clanName, int page) {
