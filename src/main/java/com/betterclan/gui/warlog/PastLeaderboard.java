...
public final class PastLeaderboard {

    private PastLeaderboard() {}
    ...
    public static void open(Player player, War war, String clanName) {
        open(player, war, clanName, null);
    }

    public static void open(Player player, War war, String clanName, String viewClanName) {
