...
public final class WarPartySelectMenu {

    private WarPartySelectMenu() {}
    ...
    public static void open(ClanManager manager, Player player, ClanWar war) {
        open(manager, player, war, null);
    }

    public static void open(ClanManager manager, Player player, ClanWar war, String viewClanName) {
