...
public final class WarHistoryMenu {

    private WarHistoryMenu() {}
    ...
    private static void openFor(ClanManager manager, Player player, String clanName, String viewClanName, int page) {
        List<ClanWar> history = manager.getWarHistory(clanName);
